...
// necessary classes
require_once('class.soapclientNusoap.php');
...
//		}
		...
		if (
			...
			$this->setError("Unsupported HTTP response status $http_status $http_reason (soapclientNusoap->response has contents of the response)");
			return false;
		}
	...
	*/
    function parseRequest($headers, $data) {
		...
		// else successfully parsed request into soapval object
			...
			// get SOAP headers
			$this->requestHeaders = $parser->getHeadersOriginal();
...
* $soapclientNusoap = new soapclientNusoap( string path [ ,boolean wsdl] );
*
* // call method, get results
* echo $soapclientNusoap->call( string methodname [ ,array parameters] );
*
* // bye bye client
* unset($soapclientNusoap);
*
* @author   Dietrich Ayala <dietrich@ganx4.com>
* @version  $Id: nusoap.php,v 1.94 2005/08/04 01:27:42 snichol Exp $
* @access   public
	...
	*/
    function parseResponse($headers, $data) {
		...
		if($errstr = $parser->getError()){
			...
			// get SOAP headers
			$this->responseHeaders = $parser->getHeadersOriginal();
			// get decoded message
